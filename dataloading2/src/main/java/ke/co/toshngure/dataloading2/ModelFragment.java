...
public class ModelFragment<M> extends Fragment implements LoaderManager.LoaderCallbacks<M>,
    ...
    protected M onLoadCache(){
        return null;
    }


    protected void onItemReady(M item) {
        mItem = item;
    ...
    private static class CacheLoader<M> extends ModelLoader<M> {
        ...
        private final ModelFragment<M> modelFragment;

        CacheLoader(Context context, ModelFragment<M> modelFragment) {
            super(context);
    ...
    @NonNull
    @Override
    public Loader<M> onCreateLoader(int id, @Nullable Bundle args) {
        return new CacheLoader<>(getActivity(), this);
    }

    @Override
    public void onLoadFinished(@NonNull Loader<M> loader, M data) {
        onItemReady(data);
    }


    @Override
    public void onLoaderReset(@NonNull Loader<M> loader) {
    ...
    private class ResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
            ...
            try {
                JSONObject itemObject = response.getJSONObject(DataParserTask.DATA);
